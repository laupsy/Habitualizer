...
public class Motion extends ActionBarActivity {
    ...
    private class LoadSetting extends AsyncTask<String, Void, Boolean> {
        ...
        protected Boolean doInBackground(String... params) {
            ...
            curSetting = u.getMotionSetting(c);
            return true;
        }
        protected void onPostExecute(Boolean result) {
            if ( curSetting == c.getResources().getString(R.string.motionSetting_on)) {
            ...
            else if ( curSetting == c.getResources().getString(R.string.motionSetting_off)) {
    ...
    private class SetSetting extends AsyncTask<String, Void, Boolean> {
        ...
        protected void onPostExecute(Boolean result) {
            // Go back
            Intent goToSettings = new Intent(Motion.this, Dashboard.class);
            Motion.this.startActivity(goToSettings);
            Motion.this.finish();
        }
    }
    ...
    private void select(){
        ...
        if ( newSetting == c.getResources().getString(R.string.motionSetting_on)) {
            on.setBackgroundColor(c.getResources().getColor(R.color.selected));
            off.setBackgroundColor(c.getResources().getColor(R.color.unselected));
        }
        else {
